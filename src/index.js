...
const sidebarData = [
  ...
  { id: 3, name: 'Date', mainColor: 'DeepSkyBlue' },
...
const footerData = [
  { id: 1, name: 'SharedArrayBuffer', mainColor: 'seagreen' },
  { id: 2, name: 'Atomics', mainColor: 'olive' },
  { id: 3, name: 'BigInt', mainColor: '#d9d9d9' },
  { id: 4, name: 'Math', mainColor: 'red' },
  { id: 5, name: 'Intl', mainColor: 'grey' },
  { id: 6, name: 'JSON', mainColor: 'Aquamarine' },
  { id: 7, name: 'AsyncGeneratorFunction', mainColor: 'GoldenRod' },
  { id: 8, name: 'AsyncFunction', mainColor: '#ffbf00' },
];
